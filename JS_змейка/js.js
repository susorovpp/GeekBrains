...
const map = {
  ...
  render(snakePointsArray, foodPoint) {
    ...
    // TODO здесь была ошибка в передаваемом параметре!!!
...
const snake = {
  ...
  init(startBody, direction) {
    ...
    // Инициализируем максимальные значения координат для краев поля
    this.maxX = this.config.getColsCount() - 1;
    this.maxY = this.config.getRowsCount() - 1;
  },
